      ...
      <header className="border-b border-b-[hsl(var(--foreground))]/10">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <motion.button
              className="px-5 py-3 rounded-full bg-primary text-primary-foreground font-medium text-md hover:bg-primary/90 transition-colors shadow-md border border-[hsl(var(--foreground))]/10 hover:shadow-xl"
